...
# Load secret key from environment; do not hard-code secrets in source.
app.secret_key = os.environ.get("FLASK_SECRET_KEY", "dev-placeholder-not-secret")
...
def mail_report():
    ...
    # Basic validation: ensure a simple email-like string
